...
Original file is located at
    https://colab.research.google.com/drive/1pWCN7CbcUoFoRkDqgiY8zctrp6YGAO2q
"""
...
while frame_count<800000:  # Run until 2000000 frames(states)
    ...
    for timestep in range(1, max_steps_per_episode):
        ...
        # Update every fourth frame only after the replay buffer is full 
        ...
        if frame_count % update_target_network == 0:
            ...
            model.save("/content/drive/MyDrive/game_ai/model/model_{}.h5".format(frame_count))
            with open("/content/drive/MyDrive/game_ai/model/history_{}.npy".format(frame_count),"wb") as nm_file:
              np.save(nm_file, episode_reward_history)
              
            #np.save("/content/drive/MyDrive/game_ai/reward_history_per_episode",episode_reward_history)
...
moving_average_returns = np.convolve(episode_reward_history, np.ones(100)/100, mode="valid")
